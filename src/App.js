...
const restrauList = [
  {
    info: {
      ...
      promoted: true,
      adTrackingId:
        "cid=16601104~p=0~adgrpid=16601104#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=328134~eid=02843b5d-1930-4767-8f80-6ea879a8560d~srvts=1723357508488~collid=45995",
      sla: {
        deliveryTime: 28,
        lastMileTravel: 2.7,
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-08-12 05:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-08-12 02:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      promoted: true,
      adTrackingId:
        "cid=15966915~p=2~adgrpid=15966915#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=855090~eid=e30cc0e9-86b1-4d6b-ae5b-5f94cdb869f2~srvts=1723357508488~collid=45995",
      sla: {
        deliveryTime: 20,
        lastMileTravel: 1.9,
        serviceability: "SERVICEABLE",
      ...
      availability: {
        nextCloseTime: "2024-08-11 17:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  return (
    <div className="restrau-list">
      {restrauList.map((restraurant) => {
        return <RestrauCard restraurant={restraurant} />;
      })}
...
const Footer = () => {
  return <h1 className="h1">Footer</h1>;
};
const AppLayout = () => {
  return (
    <>
